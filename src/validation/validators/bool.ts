...
export const is = <X>() => wrap(
  'bool.is',
  allow<X, boolean>((value) => typeof value === 'boolean', 'value is not a boolean'),
);

/**
* Check that the value is strictly `true`.
*/
export const truth = () => wrap('bool.truth', allow<unknown, true>((value) => value === true, 'value is not true'));

/**
* Check that the value is strictly `false`.
*/
export const falseness = () => wrap('bool.falseness', allow<unknown, false>((value) => value === false, 'value is not false'));
